...
# installed.
TCL_PREFIX='C:/ML_OPS/Network_Security_project/myenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/ML_OPS/Network_Security_project/myenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/ML_OPS/Network_Security_project/myenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/ML_OPS/Network_Security_project/myenv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/ML_OPS/Network_Security_project/myenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/ML_OPS/Network_Security_project/myenv\Library\lib\tclstub86.lib'
